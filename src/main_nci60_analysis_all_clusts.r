## tentatively...
setwd("/Users/kenichi/Desktop/pharmacogenomics/nci60_analysis")
...
## working directory
dir <- "/Users/kenichi/Desktop/pharmacogenomics/nci60_analysis" ## your working directory (wd)
...
save(sig.gos.all,file="sig.gos.all.rda")
}else{
    load("sig.gos.all.rda")
}
